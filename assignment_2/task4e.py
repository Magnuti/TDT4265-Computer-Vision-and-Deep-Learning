...
if __name__ == "__main__":
    ...
    utils.plot_loss(train_history_2["loss"],
                    "Training Loss 10 hidden", npoints_to_average=10, plot_variance=False)
    utils.plot_loss(
    ...
    utils.plot_loss(
        val_history_2["loss"], "Validation Loss 10 hidden", plot_variance=False)
    plt.legend()
    ...
    utils.plot_loss(train_history_2["accuracy"],
                    "Training Accuracy (10 hidden)")
    utils.plot_loss(
    ...
    utils.plot_loss(val_history_2["accuracy"],
                    "Validation Accuracy (10 hidden)")
    plt.xlabel("Number of Training Steps")
    plt.ylabel("Accuracy")
    plt.legend()
